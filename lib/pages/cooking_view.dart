...
import 'package:guests_main/pages/mealsuggest.dart'; // To access the Recipe model
import 'package:guests_main/pages/mealhistory.dart'; // Import the MealHistoryPage
