...
import 'package:guests_main/pages/mealsuggest.dart'; // Import to access the Recipe model
import 'package:guests_main/pages/cooking_view.dart'; // <-- 1. ADD THIS IMPORT
