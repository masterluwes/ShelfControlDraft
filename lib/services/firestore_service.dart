...
class FirestoreService extends ChangeNotifier {
  ...
  Future<void> setInitialHousehold(String userId) async {
    ...
    print(
        'DEBUG: Stored household ID from SharedPreferences: $storedHouseholdId');
    ...
    if (storedHouseholdId != null) {
      ...
      if (householdDoc.exists &&
        ...
        print(
            'DEBUG: Set selectedHouseholdId from stored: $selectedHouseholdId');
        return;
      }
    }
    ...
    if (userDoc.exists &&
      ...
      print(
          'DEBUG: Set selectedHouseholdId from personalHouseholdId: $selectedHouseholdId');
      ...
      if (userDoc.exists &&
        ...
        print(
            'DEBUG: Set selectedHouseholdId for registered user to personalHouseholdId: $selectedHouseholdId');
      } else {
        print(
            'DEBUG: Registered user has no personalHouseholdId. This should not happen.');
      }
    }
    print(
