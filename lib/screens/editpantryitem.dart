...
class _EditPantryItemState extends State<EditPantryItem> {
  ...
  void _initializeStateFromItem() {
    ...
    _netWeightCtrl = TextEditingController(); // Initialize empty
    _parseNetWeight(widget.item.netWeight ?? ''); // Parse the value and unit
  ...
  // --- Net Weight Helpers (copied from addpantryitem.dart) ---
  ...
  Future<void> _saveItem() async {
    ...
    String? finalImageUrl = _imageUrlFromItem;
        ...
        return AlertDialog(
          ...
          content: Column(
            ...
            children: [
              ...
              Text('Unsaved Changes', style: TextStyle(
                  color: inputTextColor, fontSize: 22, fontWeight: FontWeight.w800, fontFamily: 'Inter')),
              const SizedBox(height: 8),
              Text('Do you want to save your edits or discard them?',
          ...
          content: Column(
            ...
            children: [
              ...
              SizedBox(
                ...
                child: TextButton(
                  style: TextButton.styleFrom(
                    backgroundColor: deleteButtonRed,
                    shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8)),
                    padding: const EdgeInsets.symmetric(vertical: 14),
                  ),
                  onPressed: () {
  ...
  Widget textField(TextEditingController ctrl, {required String labelText, bool readOnly = false, VoidCallback? onTap, BorderSide? borderSide, TextInputType? keyboardType, List<TextInputFormatter>? inputFormatters, Widget? suffixIcon, String? errorText, void Function(String)? onSubmitted}) {
    return TextField(
      controller: ctrl,
      readOnly: readOnly,
      onTap: onTap,
  ...
  Widget _quantityField() {
    return InputDecorator(
      decoration: InputDecoration(
        ...
        border: OutlineInputBorder(borderRadius: BorderRadius.circular(8), borderSide: BorderSide(color: headerGreen, width: 1.5)),
        enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(8), borderSide: BorderSide(color: headerGreen, width: 1.5)),
      ),
      child: Row(
        ...
        child: Column(
          ...
          children: [
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    mainAxisSize: MainAxisSize.min,
                    children: [
                      textField(_nameCtrl, labelText: 'Item Name', borderSide: nameBorderSide),
            ...
            DropdownButtonFormField2<String>(
              ...
              onChanged: (val) => setState(() { _selectedCategory = val; if (val != null) _isCategoryInvalid = false; }),
            ),
            const SizedBox(height: 20),
