...
class Pantryinventory extends StatefulWidget {
  ...
  final Function(List<PantryItemModel>)
  onAddItems; // New callback for adding multiple items
...
class _PantryInventoryBodyState extends State<Pantryinventory> {
  ...
  void initState() {
    ...
    _items = List.from(
      widget.items,
    ); // Initialize with items passed from parent
  }
  ...
  ItemStatus _getItemStatus(PantryItemModel item) {
    if (item.expirationDate == null)
      return ItemStatus.available; // No expiry, assume available
